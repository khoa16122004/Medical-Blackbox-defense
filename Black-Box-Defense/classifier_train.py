...
parser.add_argument('--arch', default="cifar_resnet110", type=str, choices=CLASSIFIERS_ARCHITECTURES)
...
print("Khoa")
save_image(train_dataset[0][0], os.path.join(args.outdir, 'example.png'))
